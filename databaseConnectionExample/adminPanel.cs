    ...
    public partial class adminPanel : Form
    {
       ...
       // static string connectionPath = "Data Source=DESKTOP-M5EVSHF;Initial Catalog=NORTHWND;Integrated Security=True";
        ...
        private void button_deleteOrder_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand komut = new SqlCommand("DELETE from [Order Details] where OrderID=@OrderID", connection);
            SqlCommand komut2 = new SqlCommand("DELETE from Orders where OrderID=@OrderID",connection);
            komut.Parameters.AddWithValue("@OrderID",dataGridView1.CurrentRow.Cells[0].Value);
            komut2.Parameters.AddWithValue("@OrderID", dataGridView1.CurrentRow.Cells[0].Value);
            komut.ExecuteNonQuery();
